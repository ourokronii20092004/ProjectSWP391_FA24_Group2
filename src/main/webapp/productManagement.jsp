                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="image-preview-container">
                                                    <img id="addProduct_imagePreview" src="#" alt="Image Preview" class="image-preview">
                                                </div>
                                            </div>
                                        </div>   
                                        <input type="file" class="form-control w-100" id="addProduct_image" name="image" accept="image/*" onchange="previewImage(this, 'addProduct_imagePreview')">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="image-preview-container">                                   
                                                    <img id="editProduct_imagePreview" src="#" alt="Image Preview" class="image-preview">
                                                </div>
                                            </div>
                                        </div>
                                        <input type="file" class="form-control w-100" id="editProduct_image" name="image" accept="image/*" onchange="previewImage(this, 'editProduct_imagePreview')">
                                    </div>
                                    <div class="col-md-6 product-description">
                                        <label for="Product_description" class="form-label">Description:</label>
