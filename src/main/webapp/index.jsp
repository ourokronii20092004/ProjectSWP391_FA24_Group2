...
<div class="d-flex flex-column min-vh-100">
    ...
    <main class="d-flex flex-column flex-lg-row gap-4 p-4">
        ...
        <div class="d-flex flex-wrap gap-4 flex-grow-1">
            ...
            <div class="product-card">
                <img src="../img/avt2.jpg" alt="Product Image">
                <div class="p-3">
                    <a href="#"><h3 class="h5">Product 2</h3></a>
                    <p class="text-muted">$79.99</p>
                    <button class="btn btn-primary mt-2">Add to Cart</button>
                </div>
            </div>
            <div class="product-card">
                <img src="../img/avt3.jpg" alt="Product Image">
                <div class="p-3">
                    <a href="#"><h3 class="h5">Product 3</h3></a>
