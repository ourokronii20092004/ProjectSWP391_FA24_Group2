...
<!--                <%
                   // Models.ProfileData user = (Models.ProfileData) request.getSession().getAttribute("user");
                   //  if (user != null) {
                %>
                <div class="right-nav-logged-in">
                    <a href="profile.jsp">Profile</a>
                    <a href="logout.jsp">Logout</a>
               </div><% } //else { %>
                <div class="right-nav-logged-out">
        ...
        <main class="d-flex flex-column flex-lg-row p-4 row">
            <aside class="filter-section col-md-2">
            ...
            <div class="row col-md-10"> <!-- Add the row class and gap class -->
                <c:forEach items="${productList}" var="p">
                    <div class="col-lg-4 g-4 col-md-6"> 
                        <div class="card">
                            <img class="card-img-top" src="https://img-s-msn-com.akamaized.net/tenant/amp/entityid/AA1skHji.img?w=768&h=576&m=6&x=405&y=105&s=96&d=96" alt="${p.productName}">
                            <div class="card-body">
                                <a href="#"><h3 class="card-title">${p.productName}</h3></a>
                                <p class="card-text">$${p.price}</p>
                                <button class="btn btn-primary mt-2 col-12">Add to Cart</button>
                            </div>
                        </div>
                    </div>
                </c:forEach>
